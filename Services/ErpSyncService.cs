...
public class ErpSyncService
{
    ...
    private async Task<ErpEntityPayload?> BuildPayloadAsync(BikePosContext db, string entityType, string entityId, ErpConnection conn)
    {
        ...
        // Get entity via reflection-like approach
        ...
        {
            // No mappings configured — send all scalar properties with same names
        ...
        // Get ExternalId from entity
        var externalIdProp = entityProps.FirstOrDefault(p => p.Name == "ExternalId");
