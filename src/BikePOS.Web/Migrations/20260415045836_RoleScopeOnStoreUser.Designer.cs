...
namespace BikePOS.Migrations
{
    ...
    [Migration("20260415045836_RoleScopeOnStoreUser")]
    partial class RoleScopeOnStoreUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BikePOS.Models.BaseFieldLayout", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("EntityType", "FieldKey", "CompanyId")
                        .IsUnique();

                    b.ToTable("BaseFieldLayout");
                });
            ...
            modelBuilder.Entity("BikePOS.Models.ErpConnection", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BikePOS.Models.NotificationLog", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BikePOS.Models.ReceiptPrinter", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BikePOS.Models.StoreUser", b =>
                {
                    ...
                    b.HasIndex("AppUserId", "Scope", "StoreId", "CompanyId", "ConglomerateId")
                        .IsUnique();

                    b.ToTable("StoreUser");
                });

            modelBuilder.Entity("BikePOS.Models.SyncFieldMapping", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("ErpConnectionId")
                        .IsRequired()
                        .HasMaxLength(36)
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("ErpConnectionId", "EntityType", "SortOrder");

                    b.ToTable("SyncFieldMapping");
                });

            modelBuilder.Entity("BikePOS.Models.SyncLog", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BikePOS.Models.SyncFieldMapping", b =>
                {
                    b.HasOne("BikePOS.Models.ErpConnection", "ErpConnection")
                        .WithMany("FieldMappings")
                        .HasForeignKey("ErpConnectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ErpConnection");
                });
